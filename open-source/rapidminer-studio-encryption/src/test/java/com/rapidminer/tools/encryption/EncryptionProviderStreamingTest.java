...
public class EncryptionProviderStreamingTest {
	...
	private String createStringFromEncryptedBytesViaStream(byte[] encrypted, byte[] associatedData, EncryptionProviderStreaming provider) throws EncryptionException {
