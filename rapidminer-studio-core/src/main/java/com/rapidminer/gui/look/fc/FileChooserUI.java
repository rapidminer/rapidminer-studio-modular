...
public class FileChooserUI extends BasicFileChooserUI {
	...
	private static class IndentIcon implements Icon {
		...
		public void paintIcon(Component c, Graphics g, int x, int y) {
			if (icon != null) {
				if (c.getComponentOrientation().isLeftToRight()) {
					icon.paintIcon(c, g, x + depth * INDENT_SPACE, y);
				} else {
		...
		public int getIconWidth() {
			if (icon == null) {
				...
				return icon.getIconWidth() + depth * INDENT_SPACE;
			}
		}
	...
	/**
	 * Required for using a {@link FilePane} when optimized file browser selected in Settings, see implementation of
	 * {@link javax.swing.plaf.metal.MetalFileChooserUI}.
	 *
	 * @since 9.8
	 */
	private class RapidFileChooserUIAccessor implements FilePane.FileChooserUIAccessor {
		public JFileChooser getFileChooser() {
			return FileChooserUI.this.getFileChooser();
		}

		public BasicDirectoryModel getModel() {
			return FileChooserUI.this.getModel();
		}

		public JPanel createList() {
			return FileChooserUI.this.createList(getFileChooser());
		}

		public JPanel createDetailsView() {
			return FileChooserUI.this.createDetailsView(getFileChooser());
		}

		public boolean isDirectorySelected() {
			return FileChooserUI.this.isDirectorySelected();
		}

		public File getDirectory() {
			return FileChooserUI.this.getDirectory();
		}

		public Action getChangeToParentDirectoryAction() {
			return FileChooserUI.this.getChangeToParentDirectoryAction();
		}

		public Action getApproveSelectionAction() {
			return FileChooserUI.this.getApproveSelectionAction();
		}

		public Action getNewFolderAction() {
			return FileChooserUI.this.getNewFolderAction();
		}

		public MouseListener createDoubleClickListener(JList list) {
			return FileChooserUI.this.createDoubleClickListener(getFileChooser(),
					list);
		}

		public ListSelectionListener createListSelectionListener() {
			return FileChooserUI.this.createListSelectionListener(getFileChooser());
		}
	}
	...
	private final BasicFileView fileView = new RapidLookFileView();
	...
	/**
	 * Creates a {@code FileChooserUI} implementation
	 ...
	 * @return the {@code FileChooserUI} object
	 *
	...
	public void installComponents(JFileChooser fc) {
		...
		// for local files use {@link FilePane} as in {@link javax.swing.plaf.metal.MetalFileChooserUI} if optimized file chooser selected in Settings
		if (!(fsv instanceof RemoteFileSystemView) &&
				Boolean.parseBoolean(ParameterService.getParameterValue(RapidMinerGUI.PROPERTY_OPTIMIZED_FILEBROWSER))) {
			filePane = new FilePane(new RapidFileChooserUIAccessor()) {

				@Override
				public JPopupMenu getComponentPopupMenu() {
					return FileChooserUI.this.fileList.getPanePopup();
				}
			};
		...
		// views button
		this.changeViewButton = new DropDownPopupButton(CHANGE_VIEW_ACTION, () -> changeViewPopup);
		...
		// ************************************** //
		this.fileList = new FileList(this, fc, filePane);
	...
	public PropertyChangeListener createPropertyChangeListener(JFileChooser fc) {
		return new PropertyChangeListener() {
			...
			@Override
			public void propertyChange(PropertyChangeEvent e) {
				String s = Objects.toString(e.getPropertyName(), "");
				...
				switch (s) {
					...
					case JFileChooser.CONTROL_BUTTONS_ARE_SHOWN_CHANGED_PROPERTY:
						...
						break;
					case JFileChooser.FILE_HIDING_CHANGED_PROPERTY:
	...
	protected void updateView(String s) {
		if (!FILECHOOSER_VIEW_DETAILS.equals(s) && !FILECHOOSER_VIEW_ICON.equals(s) && !FILECHOOSER_VIEW_LIST.equals(s)
				&& !FILECHOOSER_VIEW_THUMBNAIL.equals(s)) {
			return;
		}
		...
		while (en.hasMoreElements()) {
			...
			if (this.getView().equals(rbm.getActionCommand())) {
