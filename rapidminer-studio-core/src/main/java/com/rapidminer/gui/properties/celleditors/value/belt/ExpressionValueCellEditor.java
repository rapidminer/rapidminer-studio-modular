 ...
 */
package com.rapidminer.gui.properties.celleditors.value.belt;
...
import com.rapidminer.gui.properties.belt.ExpressionPropertyDialog;
...
/**
 * Cell editor that contains a belt expression value.
 *
...
public class ExpressionValueCellEditor extends AbstractCellEditor implements PropertyValueCellEditor {
	...
	/** button which opens the {@link com.rapidminer.gui.properties.ExpressionPropertyDialog} */
	private JButton button;

	/** the controlling process */
	private transient Process controllingProcess;
	...
	private static Icon calculatorIcon;

	static {
		calculatorIcon = SwingTools.createIcon("16/" + CALCULATOR_NAME);
	}
	...
	/** parameter type */
	private final ParameterTypeTableExpression type;

	public ExpressionValueCellEditor(ParameterTypeTableExpression type) {
		...
		button = new JButton(calculatorIcon);
