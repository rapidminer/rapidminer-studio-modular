...
public class NominalAttributeStatisticsModel extends AbstractAttributeStatisticsModel {
	...
	/**
	 * The positive value in case of a binominal attributes.
	 *
	 * @return the positive value or the empty String
	 */
	public String getPositive() {
		String positiveString = getAttribute().getMapping().getPositiveString();
		return positiveString == null ? "" : positiveString;
	}

	/**
	 * The negative value in case of a binominal attributes.
	 *
	 * @return the negative value or the empty String
	 */
	public String getNegative() {
		String negativeString = getAttribute().getMapping().getNegativeString();
