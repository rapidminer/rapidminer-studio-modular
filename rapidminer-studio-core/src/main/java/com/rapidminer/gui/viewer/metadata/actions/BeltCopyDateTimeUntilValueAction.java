 ...
 * @since 9.7.0
 */
public class BeltCopyDateTimeUntilValueAction extends ResourceAction {

	private static final long serialVersionUID = 1L;

	/**
	 * Creates a new {@link BeltCopyDateTimeUntilValueAction} instance.
	 */
	public BeltCopyDateTimeUntilValueAction() {
