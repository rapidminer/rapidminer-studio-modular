 ...
 * @since 9.7.0
 */
public class BeltCopyColumnNameAction extends ResourceAction {

	private static final long serialVersionUID = 1L;

	/**
	 * Creates a new {@link BeltCopyColumnNameAction} instance.
	 */
	public BeltCopyColumnNameAction() {
	...
	public void loggedActionPerformed(ActionEvent e) {
		...
		Tools.copyStringToClipboard(asp.getModel().getColumnName());
	}
