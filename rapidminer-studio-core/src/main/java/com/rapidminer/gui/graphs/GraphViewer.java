...
public class GraphViewer<V, E> extends JPanel implements Renderable, PrintableComponent {
	...
	public static final Font EDGE_FONT = FontTools.getFont(Font.DIALOG, Font.PLAIN, 12);

	public static final Font EDGE_FONT_ON_PATH = FontTools.getFont(Font.DIALOG, Font.BOLD, 13);

	public static final Font VERTEX_BOLD_FONT = FontTools.getFont(Font.DIALOG, Font.BOLD, 14);

	public static final Font VERTEX_PLAIN_FONT = FontTools.getFont(Font.DIALOG, Font.BOLD, 14);
