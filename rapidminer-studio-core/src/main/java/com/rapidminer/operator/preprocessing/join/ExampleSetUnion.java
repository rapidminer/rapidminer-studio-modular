...
public class ExampleSetUnion extends Operator {
	...
	public void doWork() throws OperatorException {
		...
		try {
			ExampleSetSuperset supersetOperator = OperatorService.createEmbeddedOperator(ExampleSetSuperset.class, this);
			supersetOperator.setParameter(ExampleSetSuperset.PARAMETER_INCLUDE_SPECIAL_ATTRIBUTES, "true");
			ExampleSetMerge mergeOperator = OperatorService.createEmbeddedOperator(ExampleSetMerge.class, this);
