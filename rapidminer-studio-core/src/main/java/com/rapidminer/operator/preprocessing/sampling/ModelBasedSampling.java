...
public class ModelBasedSampling extends AbstractSamplingOperator {
	...
	protected MetaData modifyMetaData(ExampleSetMetaData metaData) {
		...
		PredictionModelMetaData modelMetaData = modelInput.getMetaDataAsOrNull(PredictionModelMetaData.class);
		if (modelMetaData != null) {
			List<AttributeMetaData> predictionAttributes = modelMetaData
					.getPredictionAttributeMetaData();
			if (predictionAttributes != null) {
				metaData.addAllAttributes(predictionAttributes);
				metaData.mergeSetRelation(modelMetaData.getPredictionAttributeSetRelation());
			}
		}
