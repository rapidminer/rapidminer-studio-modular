		...
		getTransformer().addRule(new GenerateNewMDRule(resultSetOutput, ExampleSet.class) {
			...
			public MetaData modifyMetaData(MetaData unmodifiedMetaData) {
				try {
					...
					ExampleSetMetaData refMD = referenceSetInput.getMetaDataAsOrNull(ExampleSetMetaData.class);
					ExampleSetMetaData requestMD = requestSetInput.getMetaDataAsOrNull(ExampleSetMetaData.class);
