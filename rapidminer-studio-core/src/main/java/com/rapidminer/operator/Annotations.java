...
/**
 * Instances of this class can be used to annotate {@link IOObject}s, {@link com.rapidminer.example.Attribute}s, etc.
 *
...
public class Annotations implements Serializable, Map<String, String>, Cloneable {
	...
	/**
	 * Keys that can be assigned to {@link com.rapidminer.example.Attribute}s. If you extend this list, also extend
	 * {@link com.rapidminer.gui.viewer.MetaDataViewerTableModel#COLUMN_NAMES}.
	 */
