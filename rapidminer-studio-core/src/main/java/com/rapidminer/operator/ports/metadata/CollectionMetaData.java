...
public class CollectionMetaData extends MetaData {
	...
	public CollectionMetaData() {
		this(new IOObjectCollection<>(), false);
	}
	...
	public MetaData getElementMetaDataRecursive() {
		MetaData elementMD = elementMetaData;
		while (elementMD instanceof CollectionMetaData) {
			elementMD = ((CollectionMetaData) elementMD).getElementMetaData();
		}
		return elementMD;
	}
