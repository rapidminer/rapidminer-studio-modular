...
public class MDInteger extends MDNumber<Integer> {
	...
	/**
	 * This constructor will build a {@code =0} number
	 */
	public MDInteger() {
		super(0);
	}
	...
	/**
	 * Creates an at-least 0 integer.
	 *
	 * @return >=0 MDInteger
	 * @since 9.9.0
	 */
	public static MDInteger newPossible(){
	...
	/**
	 * Creates an unknown 0 integer.
	 *
	 * @return (0,UNKNOWN) MDInteger
	 * @since 9.9.0
	 */
	public static MDInteger newUnknown(){
		MDInteger mdInteger = new MDInteger();
		mdInteger.setUnkown();
		return mdInteger;
	}
