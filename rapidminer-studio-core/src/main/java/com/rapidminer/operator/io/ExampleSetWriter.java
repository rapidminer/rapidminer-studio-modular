 ...
 * generated for dense and sparse format as well. These formats can no longer be read.
 * 
 * <dl>
 * <dt>dense:</dt>
 ...
 * <dt>sparse:</dt>
 * <dd>Only non 0 values are written to the file, prefixed by a column index.</dd>
 * </dl>
 * 
 * @see com.rapidminer.example.ExampleSet
 * 
 * @author Simon Fischer, Ingo Mierswa
 * @deprecated since 6.0, use Store operator instead
 */
@Deprecated
