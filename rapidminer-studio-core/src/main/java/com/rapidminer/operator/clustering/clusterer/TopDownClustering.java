...
public class TopDownClustering extends OperatorChain {
	...
	public void doWork() throws OperatorException {
		...
		if (getParameterAsBoolean(PARAMETER_CREATE_CLUSTER_LABEL) && exampleSetOutput.isConnected()) {
			try {
				FlattenClusterModel flattener = OperatorService.createEmbeddedOperator(FlattenClusterModel.class, this);
				...
				ClusterModel2ExampleSet applier = OperatorService.createEmbeddedOperator(ClusterModel2ExampleSet.class, this);
