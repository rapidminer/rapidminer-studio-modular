...
public class Template implements ZipStreamResource {
	...
	static final class SpecialTemplate extends Template {
		...
		SpecialTemplate(String key) {
			this.title = I18N.getGUILabel(GETTING_STARTED_LITERAL + key + I18N.SETTINGS_TYPE_TITLE_SUFFIX);
			this.shortDescription = I18N.getGUILabel(GETTING_STARTED_LITERAL + key + I18N.SETTINGS_TYPE_DESCRIPTION_SUFFIX);
			this.icon = SwingTools.createIcon("64/" + I18N.getGUILabel(GETTING_STARTED_LITERAL + key + I18N.ICON_SUFFIX));
