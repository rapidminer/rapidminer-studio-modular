...
public final class PluginSandboxPolicy extends Policy {
	 ...
	 *
	 * @deprecated since 9.8.0, use {@link SecurityTools#RAPIDMINER_INTERNAL_PERMISSION} instead
	 */
	@Deprecated
	public static final String RAPIDMINER_INTERNAL_PERMISSION = SecurityTools.RAPIDMINER_INTERNAL_PERMISSION;
