...
public class LocalRepository extends SimpleFolder implements Repository {
	 ...
	 *
	 * @see FilesystemRepositoriesTools#getDefaultRepositoryFolder(String)
	 */
	public LocalRepository(String name) throws RepositoryException {
		this(name, FilesystemRepositoriesTools.getDefaultRepositoryFolder(name));
	}
	 ...
	 *
	 * @deprecated since 9.8, use {@link FilesystemRepositoriesTools#getDefaultRepositoryFolder(String)} instead
	 */
	@Deprecated
	public static final File getDefaultRepositoryFolder(String forAlias) {
		return FilesystemRepositoriesTools.getDefaultRepositoryFolder(forAlias);
	}
