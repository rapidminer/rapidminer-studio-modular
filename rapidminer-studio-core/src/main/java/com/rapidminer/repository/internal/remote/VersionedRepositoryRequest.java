...
public class VersionedRepositoryRequest {
	...
	/**
	 * Get the information if the repository should support Git LFS
	 *
	 * @return true if Git LFS should be available
	 */
	...
	/**
	 * Set if the new repository should allow Git LFS usage
	 *
	 * @param lfsEnabled set whether the repository allows Git LFS
	 */
