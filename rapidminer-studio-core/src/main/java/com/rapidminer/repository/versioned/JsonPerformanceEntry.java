 ...
 * @since 9.10.0
 */
public class JsonPerformanceEntry extends JsonIOObjectEntry<PerformanceVector> {
	 ...
	 */
	protected JsonPerformanceEntry(String name, BasicFolder parent, Class<PerformanceVector> dataType) {
