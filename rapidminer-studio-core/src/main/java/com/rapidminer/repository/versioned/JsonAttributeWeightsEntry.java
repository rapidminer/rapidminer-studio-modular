...
/**
 * Specific {@link JsonIOObjectEntry} sub class for {@link PerformanceVector}.
 *
 * @author Jan Czogalla
 * @since 9.10.0
 */
public class JsonAttributeWeightsEntry extends JsonIOObjectEntry<AttributeWeights> {
	 ...
	 */
	protected JsonAttributeWeightsEntry(String name, BasicFolder parent, Class<AttributeWeights> dataType) {
