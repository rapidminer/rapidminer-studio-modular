...
public final class RepositoryTools {
	 ...
	 * @since 9.7
	 * @deprecated use {@see FileUtils#getSuffixFromFilename(String)} instead
	 */
	@Deprecated
	public static String getSuffixFromFilename(String name) {
		return FileUtils.getSuffixFromFilename(name);
	}
	 ...
	 * @since 9.7
	 * @deprecated use {@see FileUtils#removeSuffix(String)} instead
	 */
	@Deprecated
	public static String removeSuffix(String filename) {
		return FileUtils.removeSuffix(filename);
	}
	...
	public static String getPathWithSuffix(RepositoryLocation location) {
		return ValidationUtilV2.requireNonNull(location, "location").getPath() + findSuffix(location.getLocationType(), location.getExpectedDataEntryType());
	}
