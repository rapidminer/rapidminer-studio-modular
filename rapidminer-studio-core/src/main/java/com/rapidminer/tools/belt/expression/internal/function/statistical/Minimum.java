...
/**
 *
 * A {@link com.rapidminer.tools.belt.expression.Function} for minimum.
 *
 * @author David Arnu
 * @since 9.11
 */
public class Minimum extends AbstractArbitraryDoubleInputFunction {
	 ...
	 */
	public Minimum() {
		super("statistical.min", FunctionDescription.UNFIXED_NUMBER_OF_ARGUMENTS, ExpressionType.DOUBLE);
