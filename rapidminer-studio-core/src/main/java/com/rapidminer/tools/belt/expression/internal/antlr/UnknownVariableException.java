...
/**
 * A {@link ExpressionException} that is thrown when a variable (used as 'variable' in the expression) is
 * unknown.
 *
...
public class UnknownVariableException extends ExpressionException {
	...
	private static final long serialVersionUID = 6281355218441668503L;
