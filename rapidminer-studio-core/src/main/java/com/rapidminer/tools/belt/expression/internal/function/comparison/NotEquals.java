...
public class NotEquals extends AbstractEqualityFunctionWith2Inputs {
	...
	@Override
	protected Boolean compute(double left, Instant right) {
		return true;
	}
	...
	@Override
	protected Boolean compute(Boolean left, Instant right) {
		return true;
	}
	...
	@Override
	protected Boolean compute(String left, Instant right) {
		return true;
	}
