...
/**
 * Error strategy that does not recover after encountering an unrecognizable symbol and adjusts the error messages of
 * the {@link DefaultErrorStrategy}.
 *
 * @author Gisa Meier
 * @since 9.11
 */
class CapitulatingErrorStrategy extends DefaultErrorStrategy {
	...
	protected String getTokenErrorDisplay(Token t) {
		...
		return getSymbolText(t).replace("<EOF>", "the end");
	}
