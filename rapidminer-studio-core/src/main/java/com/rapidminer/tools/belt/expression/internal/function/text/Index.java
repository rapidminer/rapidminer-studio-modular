...
/**
 * A {@link com.rapidminer.tools.belt.expression.Function} which checks if any part of a nominal value matches a
 * specific string and returns the index of the first matching letter.
 *
