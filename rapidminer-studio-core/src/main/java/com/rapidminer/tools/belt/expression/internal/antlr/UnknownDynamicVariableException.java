...
/**
 * A {@link ExpressionException} that is thrown when a dynamic variable (used as '[var]' in the expression) is unknown.
 *
 * @author Kevin Majchrzak
 * @since 9.11
 */
public class UnknownDynamicVariableException extends ExpressionException {

	private static final long serialVersionUID = -5652589550459652699L;
