...
/**
 * Abstract class for a {@link com.rapidminer.tools.belt.expression.Function} that has arbitrary many String arguments
 * and returns a String argument.
 *
 * @author David Arnu
 * @since 9.11
 */
public abstract class AbstractArbitraryStringInputStringOutputFunction extends AbstractFunction {
	...
	public AbstractArbitraryStringInputStringOutputFunction(String i18n, int numberOfArgumentsToCheck) {
		super(i18n, numberOfArgumentsToCheck, ExpressionType.STRING);
	}
	...
	public ExpressionEvaluator compute(Callable<Void> stopChecker, ExpressionContext context,
		...
		return ExpressionEvaluatorFactory
				.ofString(makeStringCallable(inputEvaluators), isResultConstant(inputEvaluators));
	}
