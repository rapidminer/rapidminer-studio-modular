...
/**
 * A {@link com.rapidminer.tools.belt.expression.Function} for checking whether a nominal value matches a regular
 * expression
 *
...
public class Matches extends Abstract2StringInputBooleanOutputFunction {
	...
	protected Boolean compute(String value1, String value2) {
		...
		try {
			...
			throw new FunctionInputExceptionWrapper("expression_parser.invalid_regex", value2, getFunctionName());
		}
	}
