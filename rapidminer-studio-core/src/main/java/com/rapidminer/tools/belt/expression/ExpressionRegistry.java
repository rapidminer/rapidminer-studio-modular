...
import com.rapidminer.tools.belt.expression.internal.BasicConstants;
import com.rapidminer.tools.belt.expression.internal.StandardFunctionsWithConstants;
import com.rapidminer.tools.belt.expression.internal.StandardOperations;


/**
 * Registry for registering {@link ExpressionParserModule}s. Can be asked for all known ExpressionParserModules or the
 * one with a given name.
 *
...
public enum ExpressionRegistry {
	...
	/**
	 * Returns the standard {@link ExpressionParserModule}s registered by this class. Use this if you
	 * want to control which custom modules are used.
	 *
	 * @return the modules for standard functions, index functions, operations and constants generated by the core
	 */
