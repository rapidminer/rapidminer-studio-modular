...
/**
 * A {@link @link com.rapidminer.tools.belt.expression.Function} computing Euler's number e raised to the power of a double value of a number.
 *
...
public class ExponentialFunction extends Abstract1DoubleInputFunction {
	...
	public ExponentialFunction() {
		super("mathematical.exp", ExpressionType.DOUBLE);
	}
