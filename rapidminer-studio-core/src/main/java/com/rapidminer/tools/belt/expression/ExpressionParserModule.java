...
public interface ExpressionParserModule {
	...
	/**
	 * Returns the key associated to this module. The constants of this module are shown in the {@link
	 * ExpressionPropertyDialog} under the category defined by "gui.dialog.function_input.key.constant_category".
	 *
	...
	/**
	 * Returns all {@link Constant}s stored in this module. The constants are shown in the {@link
	 * ExpressionPropertyDialog} under the category defined by "gui.dialog.function_input.key.constant_category" where
	 * key is defined by {@link #getKey()}.
	 *
