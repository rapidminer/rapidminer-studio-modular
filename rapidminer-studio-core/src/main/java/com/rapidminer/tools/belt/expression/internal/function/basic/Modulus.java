...
/**
 * A {@link @link com.rapidminer.tools.belt.expression.Function} for computing the modulus.
 *
 * @author Gisa Meier
 * @since 9.11
 */
public class Modulus extends Abstract2DoubleInputFunction {
	 ...
	 */
	public Modulus() {
		super("basic.modulus", 2, ExpressionType.DOUBLE);
	}

	protected Modulus(String i18n, int numberOfArgumentsToCheck, ExpressionType returnType) {
