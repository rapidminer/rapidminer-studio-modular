...
/**
 * {@link FunctionInput} representing the input of a {@link FunctionDescription}. It contains a category, an input name,
 * input type and additional information.
 *
...
public class FunctionInput {
	 ...
	 *            additional information of the function input
	 */
	public FunctionInput(Category category, String categoryName, String name, ExpressionType type, String additionalInformation) {
	...
	/**
	 * Sets additional information to the given information.
	 *
	 * @param information the additional information to set
	 */
