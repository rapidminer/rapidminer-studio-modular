...
/**
 * A {@link @link com.rapidminer.tools.belt.expression.Function} to calculate the 'and' value of the bit representation of two integers.
 *
...
public class BitAnd extends Abstract2DoubleInputFunction {
	...
	public BitAnd() {
		super("bitwise.bit_and", 2, ExpressionType.INTEGER);
	}
