...
/**
 * A {@link ExpressionException} that is thrown when a {@link Function} has wrong arguments.
 *
 * @author Kevin Majchrzak
 * @since 9.11
 */
public class FunctionInputException extends ExpressionException {
	...
	/**
	 * Creates a parsing exception with message associated to the i18n and the arguments and stores the error line from
	 * the context.
	 *
	 * @param ctx
	 * 		the error context
