...
/**
 * A {@link com.rapidminer.tools.belt.expression.Function} which replaces all parts of a nominal value which match a
 * specific string.
 *
...
public class Replace extends AbstractArbitraryStringInputStringOutputFunction {
	...
	private String compute(String text, String target, String replacement) {
		...
		if (target.length() == 0) {
			throw new FunctionInputExceptionWrapper("expression_parser.function_missing_arguments", "search", getFunctionName());
		}
