...
/**
 * A {@link ExpressionException} that is thrown when a scope constant (used as '%{const}' or '#{const}' in the
 * expression) is unknown.
 *
 * @author Kevin Majchrzak
 * @since 9.11
 */
public class UnknownScopeConstantException extends ExpressionException {

	private static final long serialVersionUID = 5559236300421250300L;
