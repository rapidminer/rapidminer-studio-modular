...
/**
 * A {@link ExpressionException} that is thrown when the function {@link AttributeEvaluation} fails to find the
 * attribute specified by the inner expression.
 *
 * @author Kevin Majchrzak
 * @since 9.11
 */
public class AttributeEvaluationException extends ExpressionException {

	private static final long serialVersionUID = 6784243219751832542L;
	...
	AttributeEvaluationException(String functionName, String subExpression) {
		super("expression_parser.attribute_eval_failed", functionName, subExpression);
	}
