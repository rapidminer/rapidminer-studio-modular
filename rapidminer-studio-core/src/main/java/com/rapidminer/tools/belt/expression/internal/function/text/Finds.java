...
/**
 * This {@link com.rapidminer.tools.belt.expression.Function} checks whether any substring of a nominal Value matches a
 * regular expression.
 *
...
public class Finds extends Abstract2StringInputBooleanOutputFunction {
	...
	protected Boolean compute(String value1, String value2) {
		...
		try {
			...
			throw new FunctionInputExceptionWrapper("process.error.invalid_regex", value2);
		}
	}
}
