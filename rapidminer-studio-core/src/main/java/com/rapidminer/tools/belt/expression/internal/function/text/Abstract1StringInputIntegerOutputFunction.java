...
public abstract class Abstract1StringInputIntegerOutputFunction extends AbstractFunction {
	...
	public Abstract1StringInputIntegerOutputFunction(String i18n) {
		super(i18n, 1, ExpressionType.INTEGER);
	}
	...
	public ExpressionEvaluator compute(Callable<Void> stopChecker, ExpressionContext context,
		...
		return ExpressionEvaluatorFactory.ofDouble(makeDoubleCallable(eEvaluator), isResultConstant(inputEvaluators), type);
	}
	 ...
	 */
	protected DoubleCallable makeDoubleCallable(ExpressionEvaluator evaluator) {
