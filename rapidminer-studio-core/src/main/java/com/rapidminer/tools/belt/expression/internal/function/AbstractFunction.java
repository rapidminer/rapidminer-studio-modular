...
/**
 * Abstract {@link Function} that provides a constructor with i18n and helper methods to compute the result type and if
...
public abstract class AbstractFunction implements Function {
	...
	/**
	 * Constructs an AbstractFunction with {@link FunctionDescription} generated from the arguments and the function
	 * name generated from the description.
	 *
	 * @param i18nKey
	 * 		the key for the {@link FunctionDescription}. The functionName is read from "gui.dialog.function.i18nKey.name",
	 * 		the helpTextName from ".help", the groupName from ".group", the description from ".description" and the
	 * 		function with parameters from ".parameters". If ".parameters" is not present, the ".name" is taken for the
	 * 		function with parameters.
	 * @param numberOfArgumentsToCheck
	 * 		the fixed number of parameters this functions expects or {@code -1} for an unknown number
	 * @param returnType
	 * 		the resulting {@link ExpressionType}
	 */
	public AbstractFunction(String i18nKey, int numberOfArgumentsToCheck, ExpressionType returnType) {
	...
	/**
	 * Computes the resulting {@link ExpressionType} from the input types.
	 *
	 * @param inputTypes
	 * 		the input types
	...
	/**
	 * Extracts the {@link ExpressionType}s from the inputEvaluators and calls {@link #computeType(ExpressionType...)}.
	 *
