...
/**
 * A {@link @link com.rapidminer.tools.belt.expression.Function} computing signum of a number. Returns +1, if the value
 * is zero.
 *
...
public class Signum extends Abstract1DoubleInputFunction {
	...
	public Signum() {
		super("mathematical.sgn", ExpressionType.DOUBLE);
	}
