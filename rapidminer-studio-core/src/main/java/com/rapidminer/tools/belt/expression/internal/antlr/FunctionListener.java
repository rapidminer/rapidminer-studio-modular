...
import com.rapidminer.tools.expression.internal.antlr.FunctionExpressionParserBaseListener;
...
class FunctionListener extends FunctionExpressionParserBaseListener {
	...
	public void enterFunction(FunctionExpressionParser.FunctionContext ctx) {
		...
		if (expectedInputs > FunctionDescription.UNFIXED_NUMBER_OF_ARGUMENTS && currentInputs != expectedInputs) {
			throw new FunctionInputExceptionWrapper(ctx, "expression_parser.function_wrong_input", function.getFunctionName(),
