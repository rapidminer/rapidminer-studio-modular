...
/**
 * Abstract class for a comparison function that has 2 numerical or nominal inputs, but both of the same type
 *
...
public abstract class AbstractComparisonFunctionWith2Inputs extends AbstractFunction {
	...
	protected ExpressionType computeType(ExpressionType... inputTypes) {
		...
		if (type1 != type2 && !((type1 == ExpressionType.INTEGER || type1 == ExpressionType.DOUBLE)
				&& (type2 == ExpressionType.INTEGER || type2 == ExpressionType.DOUBLE))) {
			throw new FunctionInputExceptionWrapper("expression_parser.function_needs_same_type", getFunctionName());
		}
