...
/**
 * A {@link @link com.rapidminer.tools.belt.expression.Function} computing the natural logarithm (base e) of a number.
 *
...
public class NaturalLogarithm extends Abstract1DoubleInputFunction {
	...
	public NaturalLogarithm() {
		super("mathematical.ln", ExpressionType.DOUBLE);
	}
