...
/**
 * Resolver for non-dynamic variables (constants).
 *
...
public interface ConstantResolver {
	...
	/**
	 * Returns the boolean value of the variable variableName, if this variable has a boolean value. Check the
	 ...
	 */
	Instant getInstantValue(String variableName);
	 ...
	 */
	LocalTime getLocalTimeValue(String variableName);
	 ...
	 */
	StringSet getStringSetValue(String variableName);
	 ...
	 */
	StringList getStringListValue(String variableName);
