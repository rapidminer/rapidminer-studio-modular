...
/**
 * A {@link @link com.rapidminer.tools.belt.expression.Function} computing the common logarithm (base 10) of a number.
 *
...
public class CommonLogarithm extends Abstract1DoubleInputFunction {
	...
	public CommonLogarithm() {
		super("mathematical.log", ExpressionType.DOUBLE);
	}
