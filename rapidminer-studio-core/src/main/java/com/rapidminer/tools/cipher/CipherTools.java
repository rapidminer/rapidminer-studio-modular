...
/**
 * This class can be used to encrypt and decrypt given strings based on a key generated by the user. Please note that
 * classes using this tool class should first ensure that a user key is available by invoking the method
 * isKeyAvailable().
 *
