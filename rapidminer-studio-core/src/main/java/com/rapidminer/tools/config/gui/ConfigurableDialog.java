...
public class ConfigurableDialog extends ButtonDialog {
	...
	public ConfigurableDialog(Process openProcess) {
		super(ApplicationFrame.getApplicationFrame(), "configurable_dialog.deprecated", ModalityType.MODELESS, new Object[] {});
	...
	private void updateParameterPanel(Configurable config) {
		...
		if (config != null) {
			try {
				...
				removeButton.setVisible(editingAllowed);
	...
	private JPanel createParameterPanel() {
		...
		removeButton = new JButton(new ResourceActionAdapter(true, "configurable_dialog.remove_config") {
			...
			public void loggedActionPerformed(ActionEvent e) {
				...
				ConfirmDialog dialog = new ConfirmDialog(ConfigurableDialog.this, "configurable_dialog.remove_config",
						ConfirmDialog.YES_NO_OPTION, false, selectedValue.getName());
				dialog.setVisible(true);
				if (dialog.getReturnOption() == ConfirmDialog.NO_OPTION) {
					return;
				}
	...
	private JPanel createConfigurableButtonPanel() {
		...
		final JButton addButton = new JButton(new ResourceActionAdapter(false, "configurable_dialog.add_config.deprecation") {
