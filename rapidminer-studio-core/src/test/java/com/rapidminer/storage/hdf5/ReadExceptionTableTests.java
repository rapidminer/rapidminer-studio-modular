...
/**
 * Tests the exceptions that happen when giving a broken file to the  {@link Hdf5TableReader}.
 *
 * @author Gisa Meier
 */
public class ReadExceptionTableTests {
	...
	public void readAttributeMissing() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get(THIS_FOLDER,"no-columns.hdf5"), Belt.defaultContext());
	...
	public void readIllegalType() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get( THIS_FOLDER, "string-columns.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e){
	...
	public void readNegativeColumns() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get( THIS_FOLDER, "negative-columns.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e){
	...
	public void readTooManyColumns() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get( THIS_FOLDER, "too-many-columns.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e){
			assertEquals(HdfReaderException.Reason.INCONSISTENT_FILE, e.getReason());
			throw e;
		}
	...
	public void readTooManyRows() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get( THIS_FOLDER, "too-many-rows.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e){
			assertEquals(HdfReaderException.Reason.INCONSISTENT_FILE, e.getReason());
			throw e;
		}
	...
	public void readNoDictionary() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get(THIS_FOLDER, "no-dictionary.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e) {
			assertEquals(HdfReaderException.Reason.INCONSISTENT_FILE, e.getReason());
			throw e;
		}
	...
	public void readWrongType() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get(THIS_FOLDER, "wrong-type.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e) {
			assertEquals(HdfReaderException.Reason.ILLEGAL_TYPE, e.getReason());
			throw e;
		}
	...
	public void readNoType() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get(THIS_FOLDER, "no-type.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e) {
			assertEquals(HdfReaderException.Reason.MISSING_ATTRIBUTE, e.getReason());
			throw e;
		}
	...
	public void readWrongTypeType() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get(THIS_FOLDER, "wrong-type-type.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e) {
			assertEquals(HdfReaderException.Reason.ILLEGAL_TYPE, e.getReason());
			throw e;
		}
	...
	public void readDoubleValueDictionary() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get(THIS_FOLDER, "double-value-dictionary.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e) {
	...
	public void readChunkedDictionary() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get(THIS_FOLDER, "chunked-dictionary.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e) {
	...
	public void readNonStringDictionary() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get(THIS_FOLDER, "non-string-dictionary.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e) {
	...
	public void readWrongMissingType() throws IOException {
		try {
			Hdf5TableReader.read(Paths.get(THIS_FOLDER, "wrong-type-datetime.hdf5"), Belt.defaultContext());
		} catch (HdfReaderException e) {
			assertEquals(HdfReaderException.Reason.UNSUPPORTED_TYPE, e.getReason());
			throw e;
		}
